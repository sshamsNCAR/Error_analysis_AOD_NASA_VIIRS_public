...
MATCH_code_dir="/glade/u/home/sshams/code/AFRICA_SERVIR/Error_analysis_AOD_NASA/Bin/match_viirs_dt_n20"
# exec > /glade/u/home/sshams/code/AFRICA_SERVIR/Error_analysis_AOD_NASA/Bin/match_viirs_dt_n20/DT_batchrun.log 2>&1
...
while [[ $current_year -lt $END_YEAR || ($current_year -eq $END_YEAR && $current_day -le $END_DAY) ]]; do
    ...
    if [[ -d "$day_dir" ]]; then
        ...
        echo "Running match_viirs_dt_n20 for $current_year-$month-$day_of_month..."
